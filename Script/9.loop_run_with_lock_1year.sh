...
# 脚本路径
SCRIPT_SPIDER_SQLITE="$project_dir/Code/6.spider_video_details_to_sqlite_with_lock.py"
...
# 输出目录
OUTDIR_EXCEL="$result_dir/Excel/$region_id"
...
while true; do
  ...
  FILE_LOG="$log_dir/$region_id/${TIME_STAMP}_1year.log"
